...
//const editText = '//*[@class = "inputarea"]';
...
describe("Edit file contents and download versions", function(){
    ...
    it("I make the changes to the file", function(){
        ...
        // Or I must click on element, then send keystrokes
        driver.sleep(5000);
        return driver.wait(until.elementLocated(By.xpath(editText)), 2000).click();
    });
    //it("I save the changes", function(){
    //    return driver.wait(until.elementLocated(By.xpath(saveButton)), 20000).click();
    //});
    it("I navigate back to  the documents folder window", function(){

        return driver.wait(until.elementLocated(By.xpath(documentsWindowButton)), 20000).click();;
    });
    it("I open the version history of the document", function(){
        return driver.wait(until.elementLocated(By.xpath(versionHistoryButton)), 20000).click();
    });
    //it("I download the original document", function(){
    //    return driver.wait(until.elementLocated(By.xpath(versionHistory1)), 20000).click();
    //});
});
